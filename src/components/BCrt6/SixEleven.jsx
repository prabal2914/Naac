...
class SixEleven extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/bsixeleven/',{
      method:'POST',
...
render(){
  ...
  <h1 className="text-3xl font-semibold text-center text-slate-800 underline uppercase decoration-bold mb-5">
               Part B Criteria 6 Table 6.5.2
            </h1>
    <h3 className="text-3xl mb-10 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl  shadow-slate-900 ring-2 ring-slate-600">Describe any two examples of institutional reviews and
implementation of teaching learning reforms facilitated by the IQAC
within a maximum of 500 words each.</h3>

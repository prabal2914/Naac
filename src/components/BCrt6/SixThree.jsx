...
class SixThree extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/bsixthree/',{
      method:'POST',
...
render(){
  ...
  <h1 className="text-3xl font-semibold text-center text-slate-800 underline uppercase decoration-bold mb-5">
               Part B Criteria 6 Table 6.2.2
            </h1>
    <h3 className="text-3xl mb-10 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl  shadow-slate-900 ring-2 ring-slate-600">Institution Implements e-governance in its  operations.</h3>
    <div classNmae="overflow-hidden">
      <table>
            <thead>
                <tr>
<th scope="col" classNmae="px-6 py-4">
<select className="select-lg select-bordered w-full " value={this.state.area} name="area" onChange={this.changeHandler}>
<option disabled selected>Area of e-governance</option>
<option>Administration</option>
<option>Finance and accounts</option>
<option>Student Admission and Support</option>

...
Part B Criteria 5 Table 5.3.3
</h1>
<h3 className="text-xl mb-3 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl shadow-slate-900 ring-2 ring-slate-600">The institution conducts /organizes  following activities.</h3>
...
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Date of event" className="input-lg" value={this.state.date_event} name="date_event" onChange={this.changeHandler}/>
</th>
</tr> 
<tr>
<th scope="col" classNmae="px-6 py-4">
...
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Type of the Event" className="input-lg" value={this.state.type_event} name="type_event" onChange={this.changeHandler}/>
</th>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Link to the Activity" className="input-lg" value={this.state.link} name="link" onChange={this.changeHandler}/>
</th>
</tr> 
</thead>
</table>

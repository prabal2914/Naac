...
class FiveFive extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/bfivefive/',{
      method:'POST',
...
<h3 className="text-xl mb-3 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl  shadow-slate-900 ring-2 ring-slate-600">Percentage of placement of outgoing students during the last five years.</h3>
<table classNmae="min-w- text-left text-sm font-light ">
  ...
  <tr>
    ...
    <th scope="col" classNmae="px-6 py-4">
      ...
      <th scope="col" classNmae="px-6 py-4">
      <h3 className="text-sm">Name of the outgoing students placed
        </h3>
      </th>
      <th scope="col" classNmae="px-6 py-4">
    ...
    <tr>
      <th scope="col" classNmae="px-6 py-4">
      <input type="text" placeholder="Organization in which placed" className="input-lg" value={this.state.org} name="org" onChange={this.changeHandler}/>
      </th>
      <th scope="col" classNmae="px-6 py-4">
      <input type="text" placeholder="Package committed per annum" className="input-lg" value={this.state.details} name="details" onChange={this.changeHandler}/>
      </th>
    </tr> 
  </thead>
</table>

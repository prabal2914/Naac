...
class FiveEight extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/bfiveeight/',{
      method:'POST',
...
Part B Criteria 5 Table 5.3.1
</h1>
<h3 className="text-xl mb-3 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl shadow-slate-900 ring-2 ring-slate-600">Number of awards/medals won by students for outstanding performance in sports/cultural activities at inter-university/state/national/international events (award for a team event should be counted as one) during the last five years.</h3>
...
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Name of the Student" className="input-lg" value={this.state.name_st} name="name_st" onChange={this.changeHandler}/>
</th>
</tr> 
<tr>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Name of the Event" className="input-lg" value={this.state.name_event} name="name_event" onChange={this.changeHandler}/>
</th>
<th scope="col" classNmae="px-6 py-4">
<select className="select-lg select-bordered w-full " value={this.state.team_individual} name="team_individual" onChange={this.changeHandler}>
<option disabled selected>Team/Individual</option>
<option>Team</option>
<option>Individual</option>
</select>
</th>
<th scope="col" classNmae="px-6 py-4">
<select className="select-lg select-bordered w-full " value={this.state.type_int} name="type_int" onChange={this.changeHandler}>
<option disabled selected>Type</option>
<option>Inter-University</option>
<option>State</option>
...
<tr>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Date of the Event" className="input-lg" value={this.state.date_event} name="date_event" onChange={this.changeHandler}/>
</th>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Position Secured" className="input-lg" value={this.state.position} name="position" onChange={this.changeHandler}/>
</th>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Name of the Organising Institution" className="input-lg" value={this.state.name_org} name="name_org" onChange={this.changeHandler}/>
</th>
</tr> 
</thead>
</table>

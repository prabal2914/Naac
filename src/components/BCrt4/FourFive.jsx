...
class FourFive extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/bfourfive/',{
      method:'POST',
...
render(){
  ...
  <h1 className="text-3xl font-semibold text-center text-slate-800 underline uppercase decoration-bold mb-5">
    ...
    <h3 className="text-3xl mb-10 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl  shadow-slate-900 ring-2 ring-slate-600">Institution has dedicated audio visual centre, mixing equipment,
editing facility, media studio, lecture capturing system(LCS) and
related hardware and software for e-content development</h3>

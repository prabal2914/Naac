...
class TwoSix extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/btwosix/',{
      method:'POST',
...
render(){
  ...
  <h1 className="text-3xl font-semibold text-center text-slate-800 underline uppercase decoration-bold mb-5">
               Part B Criteria 2 Table 2.3.3
            </h1>
    <h3 className="text-3xl mb-10 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl  shadow-slate-900 ring-2 ring-slate-600">Preparation and adherence of Academic Calendar and Teaching
plans by the institution</h3>

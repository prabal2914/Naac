...
submitForm(){
  fetch('http://127.0.0.1:8000/api/btwoten/',{
      method:'POST',
...
Part B Criteria 2 Table 2.5.1
</h1>
<h3 className="text-xl mb-3 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl shadow-slate-900 ring-2 ring-slate-600"> Average number of days from the date of last semester-end/ year- end examination till the declaration of results during the last five years.</h3>
<h3 className="text-xl mb-3 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl shadow-slate-900 ring-2 ring-slate-600"> Number of days from the date of last semester-end/ year- end examination till the declaration of results year wise during the last five years.</h3>
...
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Programme Name" className="input-lg" value={this.state.programme} name="programme" onChange={this.changeHandler}/>
</th>
</tr> 
<tr>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Last date of semester-end exam" className="input-lg" value={this.state.date_exam} name="date_exam" onChange={this.changeHandler}/>
</th>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Date of declaration of results" className="input-lg" value={this.state.date_result} name="date_result" onChange={this.changeHandler}/>
</th>
<th scope="col" classNmae="px-6 py-4">
<input type="text" placeholder="Gap between exam and results" className="input-lg" value={this.state.gap} name="gap" onChange={this.changeHandler}/>
</th>
</tr>
</thead>
</table>

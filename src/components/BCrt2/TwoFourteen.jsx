...
class TwoFourteen extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/btwofourteen/',{
      method:'POST',
...
Part B Criteria 2 Table 2.6.3
</h1>
<h3 className="text-xl mb-3 bg-gradient-to-r from-slate-100 to-slate-300 rounded-md shadow-xl shadow-slate-900 ring-2 ring-slate-600"> Pass percentage of Students (Data only for the latest completed academic year)</h3>
...
<div>
<input type="text" placeholder="Programme Code" className="input-md" value={this.state.code} name="code" onChange={this.changeHandler}/>
<input type="text" placeholder="Programme Name" className="input-md" value={this.state.name} name="name" onChange={this.changeHandler}/>
<input type="text" placeholder="Number of Students appeared" className="input-md" value={this.state.name_student} name="name_student" onChange={this.changeHandler}/>
<input type="text" placeholder="Number of students passed" className="input-md" value={this.state.cleared} name="cleared" onChange={this.changeHandler}/>
</div>
< div className='mb-2'>
<div className="mt-5">

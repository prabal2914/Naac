...
class CriteriaOneOne extends React.Component{
...
submitForm(){
  fetch('http://127.0.0.1:8000/api/aoneone/',{
      method:'POST',
  ...
  return (
    ...
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden bg-gradient-to-r from-slate-500 to-slate-800">
        ...
        <h1 className="text-3xl font-semibold text-center text-slate-800 underline uppercase decoration-bold">
            ...
            <br></br>
            <textarea placeholder="Introduction" className="textarea textarea-bordered textarea-lg w-full p-6 max-w-5xl" value={this.state.intro} name="intro" onChange={this.changeHandler}></textarea>
